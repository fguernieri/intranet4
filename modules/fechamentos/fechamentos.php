...
<body class="bg-gray-900 text-white min-h-screen">
  <div class="flex min-h-screen w-full">
    ...
    <main class="flex-1 p-6 overflow-auto max-w-7xl mx-auto">
      ...
      <div class="card-section">
        <div class="card-header">
          <h1 class="section-title text-2xl">Fechamento Big Bear Dulc�dio</h1>
        </div>
        <div class="card-body">
          <?php if (!empty($bigBearDulcidioResumo)): ?>
            <div class="form-group mb-4 max-w-xs">
              <label for="bigbear-bonus" class="form-label">Bonifica��o (%)</label>
              <input
                type="number"
                step="0.01"
                id="bigbear-bonus"
            ...
            <div class="table-container">
              <table class="custom-table">
                ...
                <tbody>
                  ...
                  <tr class="total-row">
                    <td>Bonifica��o <span id="bigbear-bonus-percent-text"><?= number_format((float)$bigBearBonificacaoPercent, 2, ',', '.') ?></span>%</td>
