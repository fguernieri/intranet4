            ...
            <tbody>
              ...
              <tr class="border-t border-gray-600">
                <td class="px-4 py-1 border text-center text-lg font-semibold" colspan="3">
                  ...
                  <span id="bonificacao-godsave-text"><?= number_format((float)$bonificacaoBastards, 0, ',', '.') ?></span> L
                </td>
              </tr>
              <tr class="border-t border-gray-600">
                <td class="px-4 py-1 border text-center text-lg font-semibold" colspan="3">
                  TOTAL ESPECIAIS <?= (int)$litrosEspeciais ?> L = 
                  <span id="bonificacao-especiais-text"><?= number_format((float)$bonificacaoEspeciais, 0, ',', '.') ?></span> L
                </td>
              </tr>
            </tbody>
          </table>
